...
/*	snd_soc_component_read(codec, 0x19, &pwr_mngment_val);
	printk("pwr1-AINL:AINR=%d\n", pwr_mngment_val);
	snd_soc_component_read(codec, 0x2F, &pwr_mngment_val);
	printk("pwr3-LMIC:RMIC=%d\n", pwr_mngment_val);
*/
	return 0;
}
